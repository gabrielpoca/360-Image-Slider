(function() {
  $.fn.threesixty = function(image, frames) {
    threesixty(this, image, frames)
  };

  var threesixty = function (container, image, imageTotalFrames) {
    ...
    function initialize(container, image, imageTotalFrames) {
      $container = container;
      $images = $('<ol>');
      $container.append($images);

      totalFrames = imageTotalFrames;
    ...
    /**
    * Creates a new <li> and loads the image.
    */
    ...
    */
    ...
    initialize(container, image, imageTotalFrames);
  };
})();
